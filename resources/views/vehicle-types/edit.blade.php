...
<!-- Page Heading -->
 <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Edit Vehicle Type</h1>
    <a href="{{url('admin/vehicle-types/list')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
