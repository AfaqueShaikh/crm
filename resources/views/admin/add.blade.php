...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ url('admin/admin-users/list') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input color="text" class="form-control" name="email" id="name" placeholder="Enter Email"
                                required>
                        </div>
                    </div>
                </div>
