...
<div class="col-md-4">  
   <h2>Find by Vehicle</h2>
   <form class="form" method="get" action="{{url('/product-list')}}">
      <div class="form-group" >
      <select class="form-control" name="brand" id="brand" onchange="getModel(this)" required>
      ...
      <div class="form-group">
      <select class="form-control" id="model" name="model" onchange="getYear(this)" required>
         <option value="">Select Model</option>
      </select>
      </div>

      <div class="form-group">
      <select class="form-control" id="year"  name="year" onchange="getFuel(this)" required>
         <option>Select Year</option>
      </select>
      </div>

      <div class="form-group">
      <select class="form-control" id="fuel" name="fuel" onchange="getVariant(this)" required>
