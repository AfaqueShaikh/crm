		...
		<div class="container">
			...
			<div class="row mt-20">
				<div class="col-md-5">
					...
					<img class="img-responsive" style="width: 325px;" src="{{ url('/public/images/logo.png') }}" alt="product-img" />
				</div>
				<div class="col-md-7">
					<div class="single-product-details">
						...
						<div class="product-category">
							<span>Make:</span>
							<ul>
								<li>{{ $product->make->name }}</li>
							</ul>
						</div>
						<div class="product-category">
							<span>Part No:</span>
							<ul>
								<li>{{ $product->part_no }}</li>
							</ul>
						</div>
						...
						<div class="product-category">
							...
							<ul>
								<li><a href="javascript:void(0)">{{ $product->sub_category->name }}</a></li>
							</ul>
						</div>
